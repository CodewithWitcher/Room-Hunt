      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl sm:rounded-3xl p-5 sm:p-8 bg-gradient-to-b from-slate-900/95 via-indigo-950/90 to-slate-950/95 backdrop-blur-3xl border border-white/20 shadow-2xl shadow-indigo-500/20 text-white z-10 my-auto"
          >
            ...
            <button
              onClick={handleClose}
              className="absolute top-3.5 right-3.5 sm:top-4 sm:right-4 p-2 rounded-full glass-pill bg-white/10 hover:bg-white/20 text-gray-300 hover:text-white transition-all z-20"
            ...
            <div className="pr-8 mb-3">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/20 border border-rose-500/30 text-rose-300 text-[11px] sm:text-xs font-extrabold">
            ...
            {/* Modal Title */}
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-extrabold tracking-tight text-white mb-2.5 leading-snug">
            ...
            <div className="p-3 rounded-xl glass-panel border border-white/10 mb-5 grid grid-cols-2 sm:grid-cols-3 gap-2 text-[11px] sm:text-xs text-gray-200">
              ...
              <span className="flex items-center gap-1.5 font-medium truncate col-span-2 sm:col-span-1">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2.5 sm:gap-3 w-full">
              ...
              <a
                ...
                onClick={handleClose}
                className="w-full sm:w-1/2 py-3 sm:py-3.5 px-4 rounded-xl glass-pill bg-white/10 hover:bg-white/20 text-white font-bold text-xs sm:text-sm flex items-center justify-center gap-2 border border-white/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
